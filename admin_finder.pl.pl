...
system('cls');
system('Admin Control Panel Finder v2.0');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t> [!]Admin Control Panel Finder v2.0                 >\n";
print "\t>                [!]Codded By darkboss1                 >\n";
print "\t>       ======================================       >\n";
print "\t> [!]Please Visite ==> https://crackersbay.com/         >\n";
print "\t> [!]Contact Us ==> https://t.me/Error404crackersbay           >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
